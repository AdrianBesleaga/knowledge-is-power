        ...
        items: {
          ...
          properties: {
            ...
            scenarios: {
              ...
              minItems: 3,
              maxItems: 3,
              description: 'CRITICAL: Exactly 3 prediction scenarios required for this timeline. Provide 3 distinct scenarios with different outcomes (e.g., optimistic, neutral, pessimistic).',
            },
          },
        ...
        items: {
          ...
          properties: {
            ...
            scenarios: {
              ...
              minItems: 3,
              maxItems: 3,
              description: 'CRITICAL: Exactly 3 prediction scenarios required. Provide 3 distinct scenarios with different outcomes.',
            },
          },
          required: ['timeline', 'scenarios'],
        },
  ...
  COMBINED_RESEARCH: {
    ...
    properties: {
      ...
      historical: {
        ...
        maxItems: 40,
        description: 'Array of historical events covering the past 10 years. CRITICAL: Maximum 4 events per year (40 total). Select only the most significant events that had the biggest impact on the value.',
      },
    },
